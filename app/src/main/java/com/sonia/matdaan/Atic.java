...
public class Atic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Atic=findViewById(R.id.Atic);
        Atic.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.child("voted").getValue().toString().equals("no")){
                            mVoteRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    String counts = snapshot.child("Atic").getValue().toString();
                            ...
                            mVoteRef.child("Atic").setValue(""+count);
                            mUserRef.child("voted").setValue("yes");
                            startActivity(new Intent(Atic.this,Matdaan.class));
                        }
                        else {
                            Toast.makeText(Atic.this, "User already voted", Toast.LENGTH_SHORT).show();
                        }
                    }
