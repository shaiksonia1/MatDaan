                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.child("voted").getValue().toString().equals("no")){
                            mVoteRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    String counts = snapshot.child("NCP").getValue().toString();
                            ...
                            mVoteRef.child("NCP").setValue(""+count);
                            mUserRef.child("voted").setValue("yes");
                            startActivity(new Intent(Ncp.this,Matdaan.class));
                        }
                        else {
                            Toast.makeText(Ncp.this, "User already voted", Toast.LENGTH_SHORT).show();
                        }
                    }
